...
const ClickPhoto = ({ navigation, route }) => {
    ...
    const takePhoto = async () => {
        ...
        try {
            ...
            // Delay auto-save to prevent iOS crash
            setTimeout(() => {
                savePhotoToGallery(photoUri).catch(error => {
        ...
        <SafeAreaProvider>
            <SafeAreaView style={styles.safeArea}>
                ...
                <View style={styles.container}>
                   ...
                   {(showCamera || (Platform.OS === 'ios' && photo && !videoPath)) ? (
                       <Camera
                        ref={cameraRef}
                        style={styles.camera}
                        device={device}
                    ...
                    {showCamera && (
                        <TouchableOpacity
                            style={[
                                styles.shutter,
                                isRecording && { backgroundColor: "#ff0000" }
                            ]}
                            onPress={takePhoto}
