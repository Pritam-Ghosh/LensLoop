...
const PhotoEditMenu = ({
    ...
    const [isPreminumUser, setPremiumUser] = useState(false);
...
// 1 time login only to test premium features
    // useEffect(() => {
    //     AsyncStorage.removeItem("isPremium");
    // }, []);

    const handlePremiumToolPress = async (menu) => {
                ...
                <>
                    ...
                    <View style={styles.premiumSection}>
                        ...
                        <View style={styles.toolsContainer}>
                            ...
                            <TouchableOpacity style={styles.premiumTool} onPress={() => handlePremiumToolPress("portrait")}>
                            ...
                            <TouchableOpacity style={styles.premiumTool} onPress={() => handlePremiumToolPress("filters")}>
                            ...
                            <TouchableOpacity style={styles.premiumTool} onPress={() => handlePremiumToolPress()}>
